...
const checkMobile = checkPortrait;

// Snapshot current runtime characteristics
const isPortrait = checkPortrait();
const isAndroid = mobileCheck();

setIsPortrait(isPortrait);
setIsAndroid(isAndroid);

export { checkPortrait, checkMobile, mobileCheck, isPortrait, isAndroid };